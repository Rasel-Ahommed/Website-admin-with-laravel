...
<html class="no-js" lang="zxx">
  <head>
    ...
    <title>SHMU | Medical University Khulna-9100</title>
    ...
    <link rel="stylesheet" href= {{asset("assets/css/vendor/eocjs-newsticker.css")}} />


    <!-- Site Stylesheet -->
    <link rel="stylesheet" href= {{asset("assets/css/app.css")}} />
    <!-- custom element html js -->
    {{-- <script src={{asset("./assets/js/custom/navbar.js")}}></script> --}}
</head>
      ...
      <div class="header-navbar">
        <div class="header-brand">
          <div class="logo">
            <a href="">
              ...
              <img class="logo-dark" src="{{$data->site_logo}}" alt="Corporate Logo" />
            </a>
          </div>
        </div>
        ...
        <div class="nav-img">
          <div class="img-nav-left">
            <img src="{{$data->manu_banner}}" alt="mujib_logo" />
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="popup-mobile-menu">
    <div class="inner">
      <div class="header-top">
        <div class="logo">
          <a href="/">
            <img class="logo-light" src="{{asset('storage/siteImg/'.$data->site_logo)}}" alt="Corporate Logo" />
            <img class="logo-dark" src="{{asset('storage/siteImg/'.$data->site_logo)}}" alt="Corporate Logo" />
          </a>
        </div>
