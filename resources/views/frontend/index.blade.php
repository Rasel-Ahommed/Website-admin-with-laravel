                            ...
                            <div class="features-box color-primary-style SHMU-svg-animate">
                                ...
                                <div class="content">
                                    <h6 class="title fs-4 fw-light d-flex m-0">
                                        ...
                                        <a class="limited" href="event1.html">{{ $event->event_title }}</a>
                                    </h6>
                                </div>
                            </div>
                        @endforeach
                ...
                <div class="director-message-content container row m-auto" data-sal-delay="150" data-sal="slide-up"
                    ...
                    <div class="col-md-3">
                        <div class="director-img">
                            <img class="director-img-full" src="{{ asset('storage/chancellorImg/' . $data->img) }}"
                                alt="building" />
                        ...
                        @foreach ($institutes as $institute)
                            <div class="brand-grid">
                                <a href="{{ $institute->web_link }}" target="_blank">
                                    <img src="{{ asset('storage/instituteCode/' . $institute->ins_logo) }}"
                                        alt="Brand Logo" />
                                </a>
                            </div>
                        @endforeach
