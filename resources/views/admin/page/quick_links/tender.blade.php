            ...
            <tbody>
                 @foreach ($datas as $key=>$data)
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{route('edit.tender',['id'=>$data->id])}}" style='margin-right: 10px'>
                                    <button class="btn btn-primary mb-2"><i class="bi bi-pencil-square"></i></button>
                                </a>
                                <a onclick="return confirm('Are you sure to delete this notice')"href="{{route('delete.tender',['id'=>$data->id])}}">
