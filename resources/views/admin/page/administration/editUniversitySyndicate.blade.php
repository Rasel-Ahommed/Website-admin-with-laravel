...
<section class="page-content">
    ...
    <div class="section shadow">
        <div class="section-head">
            <h1>Update Univercity Syndicate Member</h1>
        </div>

        <div class="section-body pt30">
            <form action="{{route('update.univercity.syndicate',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="text-section">
                    <div class="text-content">
                        <label for="">Vice Chancellor Image : </label>
                        <div class="text-img" id="hero6">
                            <img class="img-group" src="{{asset('storage/syndicate/'.$data->img)}}" id="heroimg" /><br>
