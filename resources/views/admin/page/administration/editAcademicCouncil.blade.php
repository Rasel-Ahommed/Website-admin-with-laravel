...
<section class="page-content">
    ...
    <div class="section shadow">
        ...
        <div class="section-body pt30">
            <form action="{{route('update.academicCouncil',['id'=>$data->id])}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="text-section">
                    <div class="text-content">
                        <label for="">Vice Chancellor Image : </label>
                        <div class="text-img" id="hero6">
                            <img class="img-group" src="{{ asset('storage/academic/' . $data->img) }}" id="heroimg" /><br>
