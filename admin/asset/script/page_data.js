...
function pageInnerData(res) {
    switch (res) {
        ...
        case 'program':
            location.href = 'academic-program';
            break;
            
        case 'academiccalender':
            location.href = 'academiccalender';
            break;
        ...
        case 'events&gallery':
            location.href = 'events&gallery';
            break;

        // Quick Links 
        case 'noc':
            location.href = 'admin-noc';
            break;

        case 'apa':
            location.href = 'admin-apa';
            break;

        case 'tender':
            location.href = 'admin-tender';
            break;

        case 'circuler':
            location.href = 'admin-circuler';
            break;
